...
<tr>
    ...
    <td>
        ...
        if ($qty <= 0) echo "<span class='status-dot dot-out'></span>Out of Stock";
        elseif ($qty < 10) echo "<span class='status-dot dot-low'></span>Low Stock";
        else echo "<span class='status-dot dot-ok'></span>In Stock";
        ?>
    </td>
